...
class NeuralNetworkProgram
{
    static void Main(string[] args)
    {
        ...
        NeuralNetworkTestClass nn = new NeuralNetworkTestClass(numInput, numHidden, numOutput);
...
public class NeuralNetworkTestClass
{
    ...
    public NeuralNetworkTestClass(int numInput, int numHidden, int numOutput)
    {
